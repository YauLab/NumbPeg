...
PeakForce_PlaceCollect <- read_excel("/path/to/data/GISI_PeakForce_PlaceCollect_exp1.xlsx")
PeakForce_PlaceDeliver <- read_excel("/path/to/data/GISI_PeakForce_PlaceDeliver_exp1.xlsx")
PeakForce_RetrieveCollect <- read_excel("/path/to/data/GISI_PeakForce_RetrieveCollect_exp1.xlsx")
PeakForce_RetrieveDeliver <- read_excel("/path/to/data/GISI_PeakForce_RetrieveDeliver_exp1.xlsx")
...
contrast(emres_pc_mmDiff, interaction=c('revpairwise'), Block*Hand, by="Hand", adjust='mvt')
contrast(emres_pc_mmDiff, interaction=c('revpairwise','revpairwise'), Block*Hand, adjust='mvt')
...
contrast(emres_pd_mmDiff, interaction=c('revpairwise','revpairwise'), Block*Hand, adjust='mvt')
...
contrast(emres_rc_mmDiff, interaction=c('revpairwise','revpairwise'), Block*Hand, adjust='mvt')
...
contrast(emres_rd_mmDiff, interaction=c('revpairwise','revpairwise'), Block*Hand, adjust='mvt')
