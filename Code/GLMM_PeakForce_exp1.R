...
PlaceCollect_mmDifference <- lmer(mmDifference ~ Time*Hand + (1|Subject/Round),
...
PlaceDeliver_mmDifference <- lmer(mmDifference ~ Time*Hand + (1|Subject/Round),
...
RetrieveCollect_mmDifference <- lmer(mmDifference ~ Time*Hand + (1|Subject/Round),
...
RetrieveDeliver_mmDifference <- lmer(mmDifference ~ Time*Hand + (1|Subject/Round),
