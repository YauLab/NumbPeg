...
PlaceDeliver_mmDifference <- lmer(mmDifference ~ Block*Hand + (1|Subject/Session),
...
RetrieveCollect_mmDifference <- lmer(mmDifference ~ Block*Hand + (1|Subject/Session),
...
RetrieveDeliver_mmDifference <- lmer(mmDifference ~ Block*Hand + (1|Subject/Session),
